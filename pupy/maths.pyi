...
def partitions_gen(numero: int, min_p: int=..., max_p: Optional[int]=...) -> Any: ...
...
def n_permutations_with_replacements(it: Union[Tuple[int, int, int, int], Tuple[int, int, int, int, int, int, int], Tuple[int, int, int, int, int], Tuple[int, int, int, int, int, int]]) -> int: ...
def disjoint(a: Union[List[int], List[Union[str, int]]], b: Union[List[int], List[Union[str, int]]]) -> bool: ...
def set_cmp(a: Union[Set[int], List[int]], b: Union[Set[int], List[int]]) -> Tuple[Set[int], Set[int], Set[int]]: ...
...
class Trigon:
    ...
    pt2: Any = ...
    pt3: Any = ...
    def __init__(self, pt1: Union[Tuple[int, int]], pt2: Union[Tuple[int, int]], pt3: Union[Tuple[int, int]]) -> None: ...
    @classmethod
