...
def ls_files_dirs(dirpath: str=..., abs: Any=...) -> Tuple[List[str], List[str]]: ...
...
class LinkedTmpDir:
    ...
    file_links: Any = ...
    dir_links: Any = ...
    def __init__(self, suffix: Optional[Any] = ..., prefix: Optional[Any] = ..., dir: Optional[Any] = ..., mkdirs: Optional[Any] = ..., lndirs: Optional[Any] = ..., lnfiles: Optional[Any] = ..., link_targets: Optional[Any] = ...) -> None: ...
    def __enter__(self): ...
    def __exit__(self, exc: Any, value: Any, tb: Any) -> None: ...
    def cleanup(self) -> None: ...

def linked_tmp_dir(suffix: Optional[Any] = ..., prefix: Optional[Any] = ..., dir: Optional[Any] = ..., mkdirs: Optional[Any] = ..., lndirs: Optional[Any] = ..., lnfiles: Optional[Any] = ...) -> None: ...