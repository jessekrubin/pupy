...
def fmt_bytes(num: Any): ...
def fmt_file_size(filepath: Any): ...
def fmt_seconds(t1: Any, t2: Optional[Any] = ...): ...
def path2name(path_str: Any): ...
def parent_dirpath(fdpath: str) -> str: ...
def timestamp(ts: Optional[Any] = ...): ...
...
class LinkedTmpDir:
    ...
    file_links: Any = ...
    dir_links: Any = ...
    def __init__(self, suffix: Optional[Any] = ..., prefix: Optional[Any] = ..., dir: Optional[Any] = ..., file_targets: Optional[Any] = ..., dir_targets: Optional[Any] = ...) -> None: ...
    def __enter__(self): ...
