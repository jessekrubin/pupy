...
.. |commits-since| image:: https://img.shields.io/github/commits-since/jessekrubin/python-pupy/v2.1.1.svg
    :alt: Commits since latest release
    :target: https://github.com/jessekrubin/python-pupy/compare/v2.1.1...master
